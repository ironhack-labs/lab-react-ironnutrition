...
class App extends React.Component {
  ...
  setFood = (e) => {
    // FAILED ATTEMPT AT THE BONUS ITERATION 

    // let currentFoods = this.state.todaysFoods

    // for(let i = 0; i < currentFoods.length; i++) {
    //   if (currentFoods[i] === e.food){
    //     console.log('Existing food detected')
    //     let updatedFoods = [...this.state.todaysFoods]
    //     updatedFoods[i].amount = parseInt(updatedFoods[i].amount) + parseInt(e.amount)
    //     this.setState({
    //       todaysFoods: updatedFoods
    //     })
    //   } else {
    //     console.log('New food detected')
        this.setState({
