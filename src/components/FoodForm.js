...
const handleFormSubmit = (event) => {
    ...
    return(
        <form onSubmit={handleFormSubmit}>
            ...
            <input type="number" name="calories" onChange={handleInputChange} value={formState.calories}/>
            ...
            <input type="number" name="quantity" onChange={handleInputChange} value={formState.quantity}/>
