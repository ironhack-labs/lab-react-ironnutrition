    ...
    <div className="media-right">
      <div className="field has-addons">
        <div className="control">
          <input className="input" type="number" defaultValue={this.state.quantity} name="quantity" onChange={this.handleOnChange} />
        </div>
        <div className="control">
        ...
        <div className="control">
          <button className="button is-danger" onClick={() => this.props.handleDelete(this.props.food.name)}>
            -
          </button>
        </div>
      </div>
