...
<div className="container-global">
      <div className="left">
        ...
        this.state.foodsArray.map((element, index) => (
          <FoodBox addSomeFood={this.addSomeFood} key={index} id={index} name={element.name} calories={element.calories} image={element.image} quantity={element.quantity} handleInput={this.handleInput} />
        ))
        : 
