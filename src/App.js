...
class App extends Component {
  ...
  return (
    <div className="App">
      ...
      {this.state.formRendered || <button onClick={()=>this.renderForm(true)}>Add new food</button>}
      {this.state.formRendered || <Search search={this.getSearchInput} />}
      {this.state.formRendered ?
      <AddFoodForm renderForm={this.renderForm} addFood={this.addFood} /> :
      ...
      {this.state.formRendered || <TodaysFoods list={this.state.todaysFood}/>}
